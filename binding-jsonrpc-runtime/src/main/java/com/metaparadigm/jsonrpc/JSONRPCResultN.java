...
public class JSONRPCResultN {
    ...
    public JSONRPCResultN(int errorCode, Object id, Object o,Object exceptionTypeName)
    {
	...
	public Object getExceptionTypeName() {
	...
	if(errorCode == CODE_SUCCESS) {
		...
		data.put("exceptionTypeName",exceptionTypeName);
	    err.put("data",data);
	    o.put("id", id);
	    o.put("error", err);
	} else {
